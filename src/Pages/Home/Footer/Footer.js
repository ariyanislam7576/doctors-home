        ...
        <div>
            <div className="conatainer">
                <div className="row bg-dark">
                    <div className="col-md-4 col-12 col-sm-12 m-5 text-start text-light">
                    ...
                    <div className="col-md-2 col-sm-12 col-12 my-5 text-light">
                    ...
                    <div className="col-md-4 col-sm-12 col-12 text-light">
